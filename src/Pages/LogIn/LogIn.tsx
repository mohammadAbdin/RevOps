...
const LogIn: React.FC = () => {
  ...
  return (
    <section className="z-10 top-0 right-0 fixed bg-gray-50 dark:bg-gray-900 w-screen h-screen">
      <div className="flex flex-col items-center justify-center px-6 py-8 mx-auto md:h-screen lg:py-0">
        <a
          href="/"
          className="flex items-center mb-6 text-2xl font-semibold text-gray-900 dark:text-white"
        >
          <img className="mr-2 h-16 w-auto" src={logo} alt="logo" />
        </a>
          ...
          <div className="p-6 space-y-4 md:space-y-6 sm:p-8">
            ...
            <form className="space-y-4 md:space-y-6" onSubmit={handlelogIn}>
              ...
              <p className="text-sm font-light text-gray-500 dark:text-gray-400">
                ...
                <a
                  href="/Register"
                  className=" z-10 font-medium text-primary-600 hover:underline dark:text-primary-500"
                >
                  Sign up
                </a>
              </p>
